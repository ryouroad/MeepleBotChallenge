    ...
    articles: [
      {
        ...
        imageUrl: require('@/assets/MeepleBot/MeepleBotGPTCore.webp'), // 記事のメイン画像
        ...
        content: `
          ...
          <img src="${require('@/assets/MeepleBot/MeepleBotStrategy.webp')}" alt="ミープルボットの戦略分析">
      ...
      },
      {
        ...
        imageUrl: require('@/assets/Article/innovative-AI-research.webp'), // 記事のメイン画像
        ...
        content: `
          ...
          <img src="${require('@/assets/Article/AlphaGo.webp')}" alt="AlphaGoの勝利">
          ...
          <img src="${require('@/assets/Article/DeepBlue.webp')}" alt="Deep Blueの勝利">
          ...
          <img src="${require('@/assets/Article/Dota2.webp')}" alt="OpenAI Fiveの試合">
      ...
      },
      {
        ...
        imageUrl: require('@/assets/Article/MCTS-example.webp'), // 記事のメイン画像
        tags: ['AI×ボードゲーム（全記事表示）'] ,
        content: `
